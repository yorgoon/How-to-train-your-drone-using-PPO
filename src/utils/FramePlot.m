    ...
    methods
        function Q = FramePlot(t, state, Fmat, stl_handle)
            ...
            Q.h_frame_z = plot3(Q.h_3d, [pt(1) z_axis(1)+pt(1)], ...
             ...
             % external force
            Q.h_ext_F = plot3(Q.h_3d, [pt(1) Q.Fmat(1)+pt(1)], ...
                                      [pt(2) Q.Fmat(2)+pt(2)], ...
                                      [pt(3) Q.Fmat(3)+pt(3)], 'Color',[0.9290, 0.6940, 0.1250], 'LineWidth', 2.0);
            % Quadrotor model
...
%             Q.h_patch_stl.EdgeColor = 'none';
        ...
        function UpdatePlot(Q, t, state, Fmat)
            ...
            set(Q.h_ext_F, ...
            'XData', [pt(1) Q.Fmat(1)+pt(1)], ...
            'YData', [pt(2) Q.Fmat(2)+pt(2)], ...
            'ZData', [pt(3) Q.Fmat(3)+pt(3)]);        
